...
Most datasets that you will be working with are going to be csv files. If you have an xls file instead, convert it to a csv file first.

`df = pd.read_csv('C:/Users/Caroline/Documents/GitHub/patient-engagement/Data/Raw_Data/StonyBrookBariatric_RedcapData.csv')`
