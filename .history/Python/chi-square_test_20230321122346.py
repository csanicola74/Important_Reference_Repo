...
[Source](https: // towardsdatascience.com/compare-dependency-of-categorical-variables-with -chi-square-test-982baff64e81)
...
Expected Value Table(Image by Author)
...
Chi-Square Table(Image by author)
