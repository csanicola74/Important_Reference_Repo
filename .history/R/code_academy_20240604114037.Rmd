...
students <- students %>%
  mutate(gender = str_sub(gender_age,1,1), # this is a way to extract parts of the text in the column to create a new column; the characters start at index 1 so this is saying to only take the first character
         age = str_sub(gender_age,2)) # this is saying take the characters started from index 2 until the last character
head(students)
```
