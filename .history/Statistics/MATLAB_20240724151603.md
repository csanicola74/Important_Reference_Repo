...
| Example | Description                                                                                       |
| ------- | ------------------------------------------------------------------------------------------------- |
|         | Save the number of rows and columns in `<span class="ident">x</span>` to two different variables. |
|         | Calculate the maximum value of `<span class="ident">x</span>` and its corresponding index value.  |
